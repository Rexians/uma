...
class TestNodes(unittest.TestCase):
    ...
    def test_all_nodes(self):
        ...
        self.assertEqual(nodes['160']['node_info'], r"The Defender has a 50% chance to inflict the Attacker with Shock each time the Defender is struck or the Attacker blocks an attack. These effects will not trigger while the Defender is suffering from a Poison Debuff. The Defender also takes 100% reduced damage from Shock effects and gains a Regeneration Buff healing 1% of max health per second until the Shock expires.")
    ...
    def test_one_node(self):
        ...
        URL = 'http://127.0.0.1:8000/nodes/165'
